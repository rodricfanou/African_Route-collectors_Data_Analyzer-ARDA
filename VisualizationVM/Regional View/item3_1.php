<html>
    <head>
        ...
        <?php
            ...
            for ($i=0; $i < count($listCC); $i++) {
                if (file_exists('outputs_National_View/1_Number_ASNs_peering_in_more_than_1_IXP_per_country_lastmonth/LastMonth__number_visible_peering_ASNs_in_more_than_1_IXP_of_'.$listCC[$i][0].'.txt') == 0) {
                    $file = fopen('outputs_National_View/1_Number_ASNs_peering_in_more_than_1_IXP_per_country_lastmonth/LastMonth__number_visible_peering_ASNs_in_more_than_1_IXP_of_'.$listCC[$i][0].'.txt', "w");
                    fwrite($file, "" . PHP_EOL);
                    fclose($file);
                }
                $fileOpen = fopen('outputs_National_View/1_Number_ASNs_peering_in_more_than_1_IXP_per_country_lastmonth/LastMonth__number_visible_peering_ASNs_in_more_than_1_IXP_of_'.$listCC[$i][0].'.txt','r');
                if (!$fileOpen){
                    echo 'ERROR: No ha sido posible abrir el archivo'.$listCC[$i][0].'. Revisa su nombre y sus permisos.'; exit;
                }
            ...
            $lastYearASNs = array();
            for ($i=0; $i < count($listCC); $i++) {
                if (file_exists('outputs_National_View/1_Number_ASNs_peering_in_more_than_1_IXP_per_country_lastyear/LastYear__number_visible_peering_ASNs_in_more_than_1_IXP_of_'.$listCC[$i][0].'.txt') == 0) {
                    $file = fopen('outputs_National_View/1_Number_ASNs_peering_in_more_than_1_IXP_per_country_lastyear/LastYear__number_visible_peering_ASNs_in_more_than_1_IXP_of_'.$listCC[$i][0].'.txt', "w");
                    fwrite($file, "" . PHP_EOL);
                    fclose($file);
                }
                $fileOpen = fopen('outputs_National_View/1_Number_ASNs_peering_in_more_than_1_IXP_per_country_lastyear/LastYear__number_visible_peering_ASNs_in_more_than_1_IXP_of_'.$listCC[$i][0].'.txt','r');
                if (!$fileOpen){
                    echo 'ERROR: No ha sido posible abrir el archivo'.$listCC[$i][0].'. Revisa su nombre y sus permisos.'; exit;
                }
            ...
            $multiYearASNs = array();
            for ($i=0; $i < count($listCC); $i++) {
                if (file_exists('outputs_National_View/1_Number_ASNs_peering_in_more_than_1_IXP_per_country_multiyear/MultiYear__number_visible_peering_ASNs_in_more_than_1_IXP_of_'.$listCC[$i][0].'.txt') == 0) {
                    echo "string";
                    $file = fopen('outputs_National_View/1_Number_ASNs_peering_in_more_than_1_IXP_per_country_multiyear/MultiYear__number_visible_peering_ASNs_in_more_than_1_IXP_of_'.$listCC[$i][0].'.txt', "w");
                    fwrite($file, "" . PHP_EOL);
                    fclose($file);
                }
                $fileOpen = fopen('outputs_National_View/1_Number_ASNs_peering_in_more_than_1_IXP_per_country_multiyear/MultiYear__number_visible_peering_ASNs_in_more_than_1_IXP_of_'.$listCC[$i][0].'.txt','r');
                if (!$fileOpen){
                    echo 'ERROR: No ha sido posible abrir el archivo'.$listCC[$i][0].'. Revisa su nombre y sus permisos.'; exit;
                }
        ...
        <script type="text/javascript">
            ...
            function paint() {
                ...
                if (numero == 0) {
                    ...
                    titulo.innerHTML = "Number of visible ASNs peering (ASNs connected to the route-server) at "+IXP;
                    titulo2.innerHTML = "Number of visible ASNs peering (ASNs connected to the route-server) at "+IXP;
                    titulo3.innerHTML = "Number of visible ASNs peering (ASNs connected to the route-server) at "+IXP
                }
            }
            ...
            function drawChart(i) {
                ...
                data.addColumn('number', '# Peering ASNs');
            ...
            function descarga1(){
                ...
                if (numero == 0) {
                    ...
                    IXP = (seleccionado.value);
                    console.log (IXP)
                    downloadURI('outputs_National_View/1_Number_ASNs_peering_in_more_than_1_IXP_per_country_lastmonth/LastMonth__list_visible_ASNs_peering_at_IXP_'+IXP+'.txt','Last_5_week_number_of_Peering_ASNs_at_'+IXP+'.txt');
                }
            ...
            function descarga2(){
                ...
                if (numero == 0) {
                    ...
                    IXP = (seleccionado.value);
                    console.log (IXP)
                    downloadURI('outputs_National_View/1_Number_ASNs_peering_in_more_than_1_IXP_per_country_lastyear/LastYear__list_visible_ASNs_peering_at_IXP_'+IXP+'.txt','Last_12_Months_number_of_Peering_ASNs_at_'+IXP+'.txt');
                }
            ...
            function descarga3(){
                ...
                if (numero == 0) {
                    ...
                    console.log (IXP)
                    downloadURI('outputs/17_Number_ASNs_peering_at_IXP_visible_in_BGP_data/MultiYear__list_visible_ASNs_peering_at_IXP_'+IXP+'.txt','Multiyear_number_of_Peering_ASNs_at_'+IXP+'.txt');
                }
    ...
    <body>
        <div id="content">
            ...
            <div>
                <div id="parrafos">
                    <p class ="titulo" id="titulo1">Number of visible ASNs peering (ASNs connected to the route-server) at CC</p>     
            ...
            <div id="parrafos">
                <p class ="titulo" id="titulo2">Number of visible ASNs peering (ASNs connected to the route-server) at the CC</p>     
            ...
            <div id="separador"></div>
            <div id="parrafos">
                <p class ="titulo" id="titulo3">Number of visible ASNs peering (ASNs connected to the route-server) at the IXP</p>     
