    <head>
        ...
        <?php
            ...
            for ($i=0; $i < count($listCC); $i++) {
                if (file_exists('outputs_National_View/3_Number_unique_prefixes_visibles_at_all_IXP_of_a_country_lastmonth/LastMonth__number_unique_prefixes_at_IXP_'.$listCC[$i][0].'.txt') == 0) {
                    $file = fopen('outputs_National_View/3_Number_unique_prefixes_visibles_at_all_IXP_of_a_country_lastmonth/LastMonth__number_unique_prefixes_at_IXP_'.$listCC[$i][0].'.txt', "w");
                    fwrite($file, "" . PHP_EOL);
                    fclose($file);
                } 
                $fileOpen = fopen('outputs_National_View/3_Number_unique_prefixes_visibles_at_all_IXP_of_a_country_lastmonth/LastMonth__number_unique_prefixes_at_IXP_'.$listCC[$i][0].'.txt','r');
                if (!$fileOpen){
         ...
         $lastYearPrefixes = array();
            for ($i=0; $i < count($listCC); $i++) {
                 if (file_exists('outputs_National_View/3_Number_unique_prefixes_visibles_at_all_IXP_of_a_country_lastyear/LastYear__number_visible_prefixes_at_IXP_'.$listCC[$i][0].'.txt') == 0) {
                    $file = fopen('outputs_National_View/3_Number_unique_prefixes_visibles_at_all_IXP_of_a_country_lastyear/LastYear__number_visible_prefixes_at_IXP_'.$listCC[$i][0].'.txt', "w");
                    fwrite($file, "" . PHP_EOL);
                    fclose($file);
                } 
                $fileOpen = fopen('outputs_National_View/3_Number_unique_prefixes_visibles_at_all_IXP_of_a_country_lastyear/LastYear__number_visible_prefixes_at_IXP_'.$listCC[$i][0].'.txt','r');
                if (!$fileOpen){
            ...
            for ($i=0; $i < count($listCC); $i++) { 
                 if (file_exists('outputs_National_View/3_Number_unique_prefixes_visibles_at_all_IXP_of_a_country_multiyear/MultiYear__number_visible_prefixes_at_IXP_'.$listCC[$i][0].'.txt') == 0) {
                    $file = fopen('outputs_National_View/3_Number_unique_prefixes_visibles_at_all_IXP_of_a_country_multiyear/MultiYear__number_visible_prefixes_at_IXP_'.$listCC[$i][0].'.txt', "w");
                    fwrite($file, "" . PHP_EOL);
                    fclose($file);
                } 
                $fileOpen = fopen('outputs_National_View/3_Number_unique_prefixes_visibles_at_all_IXP_of_a_country_multiyear/MultiYear__number_visible_prefixes_at_IXP_'.$listCC[$i][0].'.txt','r');
                if (!$fileOpen){
        ...
        <script type="text/javascript">
            ...
            function paint() {
                ...
                if (numero == 0) {
                    ...
                    titulo.innerHTML = "Number of visible Prefixes at "+listIXP[0];
                    titulo2.innerHTML = "Number of visible Prefixes at "+listIXP[0];
                    titulo3.innerHTML = "Number of visible Prefixes at "+listIXP[0];
                }else{
                    drawChart(numero-1);
                    var titulo = document.getElementById("titulo1");
                    var titulo3 = document.getElementById("titulo2");
           ...
           $(window).resize(function () {
            ...
            function descarga1(){
                ...
                if (numero == 0) {
                    ...
                    IXP = (seleccionado.value).split(",")[0];
                    console.log (IXP)
                    downloadURI('outputs_National_View/3_Number_unique_prefixes_visibles_at_all_IXP_of_a_country_lastmonth/LastMonth__list_unique_prefixes_at_IXP_'+IXP+'.txt','Last_5_week_number_of_visible_prefixes_at_'+IXP+'.txt');
                }
            ...
            function descarga2(){
                ...
                if (numero == 0) {
                    ...
                    IXP = (seleccionado.value).split(",")[0];
                    console.log (IXP)
                    downloadURI('outputs_National_View/3_Number_unique_prefixes_visibles_at_all_IXP_of_a_country_lastyear/LastYear__list_visible_prefixes_at_IXP_'+IXP+'.txt','Last_12_months_number_of_visible_prefixes_at_'+IXP+'.txt');
                }
            ...
            function descarga3(){
                ...
                if (numero == 0) {
                    ...
                    IXP = (seleccionado.value).split(",")[0];
                    console.log (IXP)
                    downloadURI('outputs_National_View/3_Number_unique_prefixes_visibles_at_all_IXP_of_a_country_multiyear/MultiYear__list_visible_prefixes_at_IXP_'+IXP+'.txt','Multiyear_number_of_visible_prefixes_at_'+IXP+'.txt');
                }
