<html>
                ...
                for ($j=0; $j < 5; $j++){
                    for ($k=0; $k < count($list); $k++){
                        if (strcmp($list[$k][0],strval($j+1)) == 0) {
                            ...
                            $list2[$j][1] = intval($list[$k][6]);
                            $list2[$j][2] = intval($list[$k][7]);
                ...
                for ($j=0; $j < intval(date("Y"))-2004; $j++){
                    ...
                    for ($k=0; $k < count($list); $k++){ 
                        if (strcmp($list[$k][0],$anio) == 0) {
                            $list2[$j][0] = $list[$k][0];
                            $list2[$j][1] = intval($list[$k][2]);
                            $list2[$j][2] = intval($list[$k][3]);
                        }
                    }
                }
                $years = array();
        ...
        <script type="text/javascript">
            ...
            function paint() {
                ...
                if (numero == 0) {
                    ...
                    titulo.innerHTML = "Percentage of 2/4 Byte ASNs at all IXPs in "+IXP;
                    titulo2.innerHTML = "Percentage of 2/4 Byte ASNs at all IXPs in "+IXP;
                    titulo3.innerHTML = "Percentage of 2/4 Byte ASNs at all IXPs in "+IXP
                }
            }
            ...
            function descarga1(){
                ...
                if (numero == 0) {
                    ...
                    IXP = (seleccionado.value);
                    console.log (IXP)
                    downloadURI('outputs_National_View/1_Number_ASNs_origin_in_more_than_1_IXP_per_country_lastmonth/LastMonth__2bytes_list_origin_ASNs_in_more_than_1_IXP_in_'+IXP+'.txt','Last_5_week_list_of_ASNs_at_'+IXP+'_2bytes.txt');
                    downloadURI('outputs_National_View/1_Number_ASNs_origin_in_more_than_1_IXP_per_country_lastmonth/LastMonth__2bytes_list_origin_ASNs_in_more_than_1_IXP_in_'+IXP+'.txt','Last_5_week_list_of_ASNs_at_'+IXP+'_4bytes.txt');                
                }
            ...
            function descarga2(){
                ...
                if (numero == 0) {
                    ...
                    IXP = (seleccionado.value);
                    console.log (IXP)
                    downloadURI('outputs_National_View/1_Number_ASNs_origin_in_more_than_1_IXP_per_country_lastyear/LastYear__2bytes_list_peering_ASNs_in_more_than_1_IXP_in_'+IXP+'.txt','Last_12_months_list_of_ASNs_at_'+IXP+'_2bytes.txt');
                    downloadURI('outputs_National_View/1_Number_ASNs_origin_in_more_than_1_IXP_per_country_lastyear/LastYear__4bytes_list_peering_ASNs_in_more_than_1_IXP_in_'+IXP+'.txt','Last_12_months_week_list_of_ASNs_at_'+IXP+'_4bytes.txt');
                }
            ...
            function descarga3(){
                ...
                if (numero == 0) {
                    ...
                    IXP = (seleccionado.value)
                    console.log (IXP)
                    downloadURI('outputs_National_View/1_Number_ASNs_origin_in_more_than_1_IXP_per_country_multiyear/MultiYear__2bytes_list_origin_ASNs_in_more_than_1_IXP_in_'+IXP+'.txt','Multiyear_list_of_ASNs_at_'+IXP+'._2bytes.txt');
                    downloadURI('outputs_National_View/1_Number_ASNs_origin_in_more_than_1_IXP_per_country_multiyear/MultiYear__4bytes_list_origin_ASNs_in_more_than_1_IXP_in_'+IXP+'.txt','Multiyear_list_of_ASNs_at_'+IXP+'._4bytes.txt');
                }
    ...
    <body>
        <div id="content">
            ...
            <div>
                <div id="parrafos">
                    <p class ="titulo" id="titulo1">Percentage of 2/4 Byte ASNs at all IXPs in CC</p>     
            ...
            <div id="parrafos">
                <p class ="titulo" id="titulo2">Percentage of 2/4 Byte ASNs at all IXPs in CC</p>     
            ...
            <div id="separador"></div>
            <div id="parrafos">
                <p class ="titulo" id="titulo3">Percentage of 2/4 Byte ASNs at all IXPs in CC</p>     
