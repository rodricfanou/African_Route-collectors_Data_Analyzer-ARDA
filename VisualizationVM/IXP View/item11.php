<html>
    <head>
        ...
        <?php
            ...
            for ($i=0; $i < count($listIXP); $i++) {
                if (file_exists('outputs/17_Number_ASNs_peering_at_IXP_visible_in_BGP_data_lastmonth/LastMonth__number_visible_ASNs_peering_at_IXP_'.$listIXP[$i][0].'.txt') == 0) {
                    $file = fopen('outputs/17_Number_ASNs_peering_at_IXP_visible_in_BGP_data_lastmonth/LastMonth__number_visible_ASNs_peering_at_IXP_'.$listIXP[$i][0].'.txt', "w");
                    fwrite($file, "" . PHP_EOL);
                    fclose($file);
                }
                $fileOpen = fopen('outputs/17_Number_ASNs_peering_at_IXP_visible_in_BGP_data_lastmonth/LastMonth__number_visible_ASNs_peering_at_IXP_'.$listIXP[$i][0].'.txt','r');
                if (!$fileOpen){
            ...
            $lastYearASNs = array();
            for ($i=0; $i < count($listIXP); $i++) {
                if (file_exists('outputs/17_Number_ASNs_peering_at_IXP_visible_in_BGP_data/LastYear__number_visible_ASNs_peering_at_IXP_'.$listIXP[$i][0].'.txt') == 0) {
                    $file = fopen('outputs/17_Number_ASNs_peering_at_IXP_visible_in_BGP_data/LastYear__number_visible_ASNs_peering_at_IXP_'.$listIXP[$i][0].'.txt', "w");
                    fwrite($file, "" . PHP_EOL);
                    fclose($file);
                }
                $fileOpen = fopen('outputs/17_Number_ASNs_peering_at_IXP_visible_in_BGP_data/LastYear__number_visible_ASNs_peering_at_IXP_'.$listIXP[$i][0].'.txt','r');
                if (!$fileOpen){
                    echo 'ERROR: No ha sido posible abrir el archivo'.$listIXP[$i][0].'. Revisa su nombre y sus permisos.'; exit;
                }
            ...
            $multiYearASNs = array();
            for ($i=0; $i < count($listIXP); $i++) {
                if (file_exists('outputs/17_Number_ASNs_peering_at_IXP_visible_in_BGP_data/MultiYear__number_visible_ASNs_peering_at_IXP_'.$listIXP[$i][0].'.txt') == 0) {
                    $file = fopen('outputs/17_Number_ASNs_peering_at_IXP_visible_in_BGP_data/MultiYear__number_visible_ASNs_peering_at_IXP_'.$listIXP[$i][0].'.txt', "w");
                    fwrite($file, "" . PHP_EOL);
                    fclose($file);
                }
                $fileOpen = fopen('outputs/17_Number_ASNs_peering_at_IXP_visible_in_BGP_data/MultiYear__number_visible_ASNs_peering_at_IXP_'.$listIXP[$i][0].'.txt','r');
                if (!$fileOpen){
                    echo 'ERROR: No ha sido posible abrir el archivo'.$listIXP[$i][0].'. Revisa su nombre y sus permisos.'; exit;
                }
           ...
           $(window).resize(function () {
            ...
            function descarga1(){
                ...
                if (numero == 0) {
                    ...
                    IXP = (seleccionado.value).split(",")[0];
                    console.log (IXP)
                    downloadURI('outputs/17_Number_ASNs_peering_at_IXP_visible_in_BGP_data_lastmonth/LastMonth__list_visible_ASNs_peering_at_IXP_'+IXP+'.txt','Last_5_week_number_of_viseble_ASN_peering_at_'+IXP+'_raw_data.txt');
                }
            ...
            function descarga2(){
                ...
                if (numero == 0) {
                    ...
                    IXP = (seleccionado.value).split(",")[0];
                    console.log (IXP)
                    downloadURI('outputs/17_Number_ASNs_peering_at_IXP_visible_in_BGP_data/LastYear__list_visible_ASNs_peering_at_IXP_'+IXP+'.txt','Last_12_months_number_of_viseble_ASN_peering_at_'+IXP+'_raw_data.txt');
                }
            ...
            function descarga3(){
                ...
                if (numero == 0) {
                    ...
                    IXP = (seleccionado.value).split(",")[0];
                    console.log (IXP)
                    downloadURI('outputs/17_Number_ASNs_peering_at_IXP_visible_in_BGP_data/MultiYear__list_visible_ASNs_at_IXP_'+IXP+'.txt','Multiyear_number_of_viseble_ASN_peering_at_'+IXP+'_raw_data.txt');
                }
    ...
    <body>
        <div id="content">
            ...
            <div>
                <div id="parrafos">
                    <p class ="titulo" id="titulo1">Number of visible ASNs peering (ASNs connected to the route-server) at the IXP</p>     
            ...
            <div id="parrafos">
                <p class ="titulo" id="titulo2">Number of visible ASNs peering (ASNs connected to the route-server) at the IXP</p>     
