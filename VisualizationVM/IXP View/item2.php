<html>
        ...
        <script type="text/javascript">
            ...
            function paint() {
                ...
                if (numero == 0) {
                    ...
                    titulo.innerHTML = "Number of visible ASNs at "+IXP;
                    titulo2.innerHTML = "Number of visible ASNs at "+IXP;
                    titulo3.innerHTML = "Number of visible ASNs at "+IXP;
                }
            }
           ...
           $(window).resize(function () {
            ...
            function descarga1(){
                ...
                if (numero == 0) {
                    ...
                    IXP = (seleccionado.value).split(",")[0];
                    console.log (IXP)
                    downloadURI('outputs/2_Number_Origin_ASNs_visibles_at_an_IXP_lastmonth/LastMonth__list_visible_ASNs_at_IXP_'+IXP+'.txt','Last_5_week_number_of_visible_ASN_at_'+IXP+'_raw_data.txt');
                }
            ...
            function descarga2(){
                ...
                if (numero == 0) {
                    ...
                    IXP = (seleccionado.value).split(",")[0];
                    console.log (IXP)
                    downloadURI('outputs/2_Number_Origin_ASNs_visibles_at_an_IXP_multiyear_lastyear/LastYear__list_visible_ASNs_at_IXP_'+IXP+'.txt','Last_12_months_number_of_visible_ASN_at_'+IXP+'_raw_data.txt');
                }
            ...
            function descarga3(){
                ...
                if (numero == 0) {
                    ...
                    IXP = (seleccionado.value).split(",")[0];
                    console.log (IXP)
                    downloadURI('outputs/2_Number_Origin_ASNs_visibles_at_an_IXP_multiyear_lastyear/MultiYear__list_visible_ASNs_at_IXP_'+IXP+'.txt','Multiyear_number_of_visible_ASN_at_'+IXP+'_raw_data.txt');
                }
    ...
    <body>
        <div id="content">
            ...
            <div>
                <div id="parrafos">
                    <p class ="titulo" id="titulo1">Number of visible ASNs at the IXP</p>     
            ...
            <div id="parrafos">
                <p class ="titulo" id="titulo2">Number of visible ASNs at the IXP</p>     
            ...
            <div id="separador"></div>
            <div id="parrafos">
                <p class ="titulo" id="titulo3">Number of visible ASNs at the IXP</p>     
