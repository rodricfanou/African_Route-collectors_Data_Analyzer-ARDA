<html>
    <head>
        ...
        <?php
            ...
            if (file_exists('outputs_Regional_View/3_Number_of_prefixes_visible_at_all_IXPs_last_month/LastMonth__number_prefixes_visible_at_all_IXPs.txt') == 0) {
                $file = fopen('outputs_Regional_View/3_Number_of_prefixes_visible_at_all_IXPs_last_month/LastMonth__number_prefixes_visible_at_all_IXPs.txt', "w");
                fwrite($file, "" . PHP_EOL);
                fclose($file);
            } 
            $fileOpen = fopen('outputs_Regional_View/3_Number_of_prefixes_visible_at_all_IXPs_last_month/LastMonth__number_prefixes_visible_at_all_IXPs.txt','r');
            if (!$fileOpen){
            ...
            if (file_exists('outputs_Regional_View/3_Number_of_prefixes_visible_at_all_IXPs_lastyear/LastYear__number_prefixes_visible_at_all_IXPs.txt') == 0) {
                $file = fopen('outputs_Regional_View/3_Number_of_prefixes_visible_at_all_IXPs_lastyear/LastYear__number_prefixes_visible_at_all_IXPs.txt', "w");
                fwrite($file, "" . PHP_EOL);
                fclose($file);
            } 
            $fileOpen = fopen('outputs_Regional_View/3_Number_of_prefixes_visible_at_all_IXPs_lastyear/LastYear__number_prefixes_visible_at_all_IXPs.txt','r');
            if (!$fileOpen){
           ...
           for ($z = 0; $z <= 12; $z++) {
            ...
            if (file_exists('outputs_Regional_View/3_Number_of_prefixes_visible_at_all_IXPs_multiyear/MultiYear__number_prefixes_visible_at_all_IXPs.txt') == 0) {
                $file = fopen('outputs_Regional_View/3_Number_of_prefixes_visible_at_all_IXPs_multiyear/MultiYear__number_prefixes_visible_at_all_IXPs.txt', "w");
                fwrite($file, "" . PHP_EOL);
                fclose($file);
            } 
            $fileOpen = fopen('outputs_Regional_View/3_Number_of_prefixes_visible_at_all_IXPs_multiyear/MultiYear__number_prefixes_visible_at_all_IXPs.txt','r');
            if (!$fileOpen){
        ...
        <script type="text/javascript">
           ...
           $(window).resize(function () {
            ...
            function descarga1(){
                downloadURI('outputs_Regional_View/3_Number_of_prefixes_visible_at_all_IXPs_last_month/LastMonth__list_prefixes_visible_at_all_IXPs.txt','lastMonthPrefixes.txt');            
            }

            function descarga2(){
                downloadURI('outputs_Regional_View/3_Number_of_prefixes_visible_at_all_IXPs_multiyear/LastYear__list_prefixes_visible_at_all_IXPs.txt','lastYearPrefixes.txt');   
            }

            function descarga3(){
                downloadURI('outputs_Regional_View/3_Number_of_prefixes_visible_at_all_IXPs_multiyear/MultiYear__list_prefixes_visible_at_all_IXPs.txt','multiYearPrefixes.txt');
            }
    ...
    <body>
        <div id="content">
            ...
            <div>
                <div id="parrafos">
                    <p class ="titulo" id="titulo1">Number of Prefixes visible  at all IXPs in Africa </p>     
            ...
            <div id="parrafos">
                <p class ="titulo" id="titulo2">Number of Prefixes visible  at all IXPs in Africa</p>     
            ...
            <div id="separador"></div>
            <div id="parrafos">
                <p class ="titulo" id="titulo3">Number of Prefixes visible at all IXPs in Africa</p>     
