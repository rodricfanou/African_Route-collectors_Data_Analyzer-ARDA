## Schedule the run of the scripts, which compute the statistics for the IXP view.
## This script is run daily. => put it in the cron for everyday at 1 am, 9 am and 5pm (17h)
## Alert: To achiev this add the following lines to the cronjob
...
## import all files the needed libraries 
...
number_of_script_not_to_exceed = 4
...
directory = ['/home/roderick/Heart/3_IXPView/', '/home/roderick/Heart/4_NationalView/', '/home/roderick/Heart/5_RegionalView/']
...
import os.path
os.chdir('/home/roderick/Heart/6_scheduler')
...
#Priority_queue_list =  {'4_NationalView_1_percentage_Origin_ASNs_by_country_assignment_multiyear_v5.py': '/home/roderick/Heart/4_NationalView/12_local_external_ASNs_multiyear'}
...
if len(Priority_queue_list_copy.keys()) > 0:
    ...
    if number_of_script_running <= number_of_script_not_to_exceed :
        ...
        for script in Priority_queue_list:
            ...
            tab = CronTab(user = 'roderick')
            #direc = '/home/roderick/Heart/6_scheduler'
            direc = Priority_queue_list[script]
            os.chdir(direc)
            #cmd = 'cd ' + '/home/roderick/Heart/6_scheduler '+  ' && ' + ' python ' + 'test1.py'
            ...
            #cmd = 'python ' + 'test.py'
            #tab = CronTab(user='roderick',fake_tab='True')
...
if len(Priority_queue_list) == 0:
    ...
    Categories = [ '3_IXPView', '4_NationalView', '5_RegionalView',  '3_IXPView']
