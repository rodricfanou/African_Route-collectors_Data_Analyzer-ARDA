...
directory = ['/home/arda/African_Route-collectors_Data_Analyzer-ARDA/ComputationVM/Heart/3_IXPView/']
...
for row in cur.fetchall():
    ...
    if Priority_queue_add == 'Yes' and '3_IXPView_' in script:
...
if len(Priority_queue_list) == 0:
    ...
    for Category in Categories:
        ...
        query = """select * from Infos_on_all_scripts_to_run where Current_Status = 'Not Running' and Script_to_execute like '3_IXPView%' """
        cur.execute(query)
