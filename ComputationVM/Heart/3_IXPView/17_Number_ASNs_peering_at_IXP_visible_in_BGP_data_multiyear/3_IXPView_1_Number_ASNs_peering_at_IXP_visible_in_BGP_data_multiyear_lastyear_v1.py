...
if List_all_tables >0:
    ...
    for ixp in IXP_collector.keys():
        ...
        create_output_lastyear_2bytesASN = open(output_folder+'LastYear__2bytes_list_visible_ASNs_peering_at_IXP_'+ixp+'.txt', 'a')
        
        create_output_lastyear_2bytesASN.write('###Month-Year; Visible 2bytes ASNs peering at IXP \n')
        
        create_output_lastyear_4bytesASN = open(output_folder+'LastYear__4bytes_list_visible_ASNs_peering_at_IXP_'+ixp+'.txt', 'a')
        ...
        create_output_MultiYear_2bytesASN = open(output_folder+'MultiYear__2bytes_list_visible_ASNs_peering_at_IXP_'+ixp+'.txt', 'a')
        
        create_output_MultiYear_2bytesASN.write('###Month-Year; Visible 2bytes ASNs peering at IXP\n')
            
        create_output_MultiYear_4bytesASN = open(output_folder+'MultiYear__4bytes_list_visible_ASNs_peering_at_IXP_'+ixp+'.txt', 'a')
        ...
        if ixp in month_ASN.keys():
            ...
            create_output_lastyear = open(output_folder+'LastYear__number_visible_ASNs_peering_at_IXP_'+ixp+'.txt', 'a')
            
            create_output_lastyear.write('##Month-Year; Number of Origin ASNs; Number of 2bytes ASNs peering at IXP; Number of 4bytes ASNs peering at IXP \n')
        ...
        if ixp in year_ASN.keys():
            ...
            create_output_MultiYear =  open(output_folder+'MultiYear__number_visible_ASNs_peering_at_IXP_'+ixp+'.txt', 'a')
            
            create_output_MultiYear.write('##Year' + '; Number of OriginASNs ; Number of 2bytes ASNs peering at IXP; Number of 4bytes ASNs peering at IXP \n')
