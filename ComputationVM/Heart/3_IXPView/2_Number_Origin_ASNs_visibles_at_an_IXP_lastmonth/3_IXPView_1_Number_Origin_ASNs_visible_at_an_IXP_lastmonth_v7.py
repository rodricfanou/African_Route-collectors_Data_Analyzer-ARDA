...
if List_all_tables >0:
    ...
    for ixp in IXP_collector.keys():
      ...
      create_output.write('###Num Week; Timestamp beginning;  Timestamp end;  Datetime  beginning;  Datetime end; Visible Origin ASNs \n')
      
      create_output_2bytesASN =  open(output_folder+'LastMonth__2bytes_list_visible_ASNs_at_IXP_'+ixp+'.txt', 'a')
      
      create_output_2bytesASN.write('###Num Week; Timestamp beginning;  Timestamp end;  Datetime  beginning;  Datetime end; Visible 2bytes Origin ASNs \n')
      
      create_output_4bytesASN =  open(output_folder+'LastMonth__4bytes_list_visible_ASNs_at_IXP_'+ixp+'.txt', 'a')
      
      create_output_4bytesASN.write('###Num Week; Timestamp beginning;  Timestamp end;  Datetime  beginning;  Datetime end; Visible 4bytes Origin ASNs \n')
    ...
    for ixp in week_ASN.keys():
        ...
        create_output.write('##Num Week' + '; Timestampbeg; Timestampend; Number of OriginAS; Number of Visible 2bytes Origin ASN; Number of Visible 4bytes Origin ASN  \n')
