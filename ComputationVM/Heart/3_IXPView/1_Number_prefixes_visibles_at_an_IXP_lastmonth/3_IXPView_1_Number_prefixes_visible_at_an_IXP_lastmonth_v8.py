...
for ixp in list(IXP_collector.keys()):
    ...
    create.write(
        '###Num Week; Timestamp beginning;  Timestamp end;  Datetime  beginning;  Datetime end; Visible prefixes at IXP; Bogon ? \n')
...
if List_all_tables > 0:
                        ...
                        if 'None' not in prefix:
                            ...
                            if check_bogon:
                                ...
                                if prefix not in week_prefix_bogon[ixp][week]:
                                    ...
                                    create_output.write(
                                        str(week) + '; ' + '; '.join(tab) + '; ' + str(prefix) + '; bogon\n')
    ...
    for ixp in list(week_prefix.keys()):
        ...
        create_output1.write(
            '###Num Week; Timestamp beginning;  Timestamp end;  Datetime  beginning;  Datetime end; number visible prefixes at IXP; number of visible bogon prefixes at IXP \n')
        ...
        for week in list(week_prefix[ixp].keys()):
            ...
            create_output1.write(
                str(week) + '; ' + '; '.join(tab) + '; ' + str(len(list(set(week_prefix[ixp][week])))) + '; ' + str(
                    len(list(set(week_prefix_bogon[ixp][week])))) + '\n')
