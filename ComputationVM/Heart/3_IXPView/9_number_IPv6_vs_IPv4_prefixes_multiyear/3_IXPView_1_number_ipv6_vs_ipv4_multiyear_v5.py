        ...
        for year in yearList:
            ...
            for month in range(1,13):
                if 'Data__' + str(year) + "_" + str(month) in List_all_tables:
                    ...
                    k = 0
                    query = "select distinct Network, IP_version, OriginAS, ASpath from Data__"+str(year)+"_"+str(month) + " where"
            ...
            if len(year_prefix[ixp][year]) > 0:
                ...
                for IPversion in list(month_prefix[ixp][id_month_and_year].keys()):
                    ...
                    if IPversion + 'added' not in entete:
                        ...
                        with open(output_folder+'LastYear_'+ixp+'_Number_ASNs_announcing_'+IPversion+'.txt', 'a') as fg1:
                    ...
                    with open(output_folder+'LastYear_'+ixp+'_List_ASNs_announcing_'+IPversion+'.txt', 'a') as fg2:
                ...
                if len(year_prefix[ixp][year]) > 0:
                    ...
                    for IPversion in list(year_prefix[ixp][year].keys()):
                        ...
                        if IPversion + 'added' not in entete:
                            ...
                            with open(output_folder+'MultiYear_'+ixp+'_Number_ASNs_announcing_'+IPversion+'.txt', 'a') as fg1:
                        ...
                        with open(output_folder+'MultiYear_'+ixp+'_Number_ASNs_announcing_'+IPversion+'.txt', 'a') as fg4:
                            
                            fg4.write('%s; %s\n' %(year, len(year_prefix[ixp][year][IPversion]) ))
                        
                        
                        
                        with open(output_folder+'MultiYear_'+ixp+'_List_ASNs_announcing_'+IPversion+'.txt', 'a') as fg3:
