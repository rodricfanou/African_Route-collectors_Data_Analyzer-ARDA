...
name_log_file = 'Log_' + str(
    now_datetime) + '_' + '5_Number_prefixes_visible_at_an_IXP_multiyear_lastyear_better' + '.txt'
...
for ixp in list(IXP_collector.keys()):
    if ixp in list(month_prefix.keys()):
        ...
        for id_month_and_year in list(month_prefix[ixp].keys()):
            ...
            print(list(month_prefix[ixp].keys()))
                ...
                for CC in list(CC_IXP.keys()):
                    for ixp1 in CC_IXP[CC]:
                        ...
                        if ixp == ixp1:
                            ...
                            intersection = list(
                                set(month_prefix[ixp][id_month_and_year]) & set(CC_ASNs_AFRINIC[current_CC]))
                            ...
                            try:
                                ...
                                percentage_local_AF = float(len(intersection)) / float(
                                    len(month_prefix[ixp][id_month_and_year])) * 100
                            except:
                            ...
                            with open(filename, 'a') as fd:
                                ...
                                try:
                                    ...
                                    print('Amonth_prefix[ixp][id_month_and_year] = ',
                                          month_prefix[ixp][id_month_and_year])
                                    ...
                                    current_CC, ixp, id_month_and_year, len(intersection),
                                    len(month_prefix[ixp][id_month_and_year]), percentage_local_AF,
                                    ...
                                    print('month_prefix[ixp][id_month_and_year] = ',
                                          month_prefix[ixp][id_month_and_year])
                    ...
                    if ixp == ixp1:
                        ...
                        with open(filename, 'a') as fd:
                            ...
                            try:
                                A = pycountry.countries.get(alpha2=current_CC)
                                fd.write('%s;%s;%s;%s;%s;%s;%s\n' % (
                                current_CC, ixp, year, len(intersection), len(year_prefix[ixp][year]),
