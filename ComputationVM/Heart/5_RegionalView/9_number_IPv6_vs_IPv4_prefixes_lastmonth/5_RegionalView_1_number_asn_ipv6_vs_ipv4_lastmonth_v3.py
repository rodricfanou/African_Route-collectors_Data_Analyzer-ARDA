...
with open(output_folder + 'LastMonth__list_Origin_ASNs_advertising_v4_prefixes_at_all_IXPs.txt', 'a') as fg:
    fg.write('%s' % (
        '###Num Week; Timestamp beginning;  Timestamp end;  Datetime beginning;  Datetime end; Visible ASNs advertising v4 prefixes\n'))
...
with open(output_folder + 'LastMonth__list_Origin_ASNs_advertising_v6_prefixes_at_all_IXPs.txt', 'a') as fg:
    fg.write('%s' % (
        '###Num Week; Timestamp beginning;  Timestamp end;  Datetime beginning;  Datetime end; Visible ASNs advertising v6 prefixes\n'))
...
with open(output_folder + 'LastMonth__number_Origin_ASNs_advertising_v4_v6_prefixes_at_all_IXPs.txt', 'a') as fg:
    fg.write('%s' % (
        '###Num Week; Timestamp beginning;  Timestamp end;  Datetime beginning;  Datetime end; Number ASNs advertising v4 prefixes;  Number ASNs advertising v6 prefixes \n'))
