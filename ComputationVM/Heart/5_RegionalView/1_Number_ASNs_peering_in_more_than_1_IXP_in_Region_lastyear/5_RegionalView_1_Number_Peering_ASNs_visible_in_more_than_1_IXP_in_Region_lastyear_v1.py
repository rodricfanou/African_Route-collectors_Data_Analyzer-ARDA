...
name_log_file = 'Log_' + str(
    now_datetime) + '_' + 'RegionalView_1_Number_Peering_ASNs_visible_at_an_IXP_lastyear' + '.txt'
...
if os.listdir(IXPView_output_folder) != []:
    ...
    create_output_2bytesASN_list = open(
        output_folder + 'LastYear__2bytes_list_visible_ASNs_peering_in_more_than_1_IXP.txt', 'a')

    create_output_2bytesASN_list.write('###Month-Year; Visible 2bytes Peering ASNs \n')

    create_output_2bytesASN_num = open(
        output_folder + 'LastYear__2bytes_number_visible_ASNs_peering_in_more_than_1_IXP.txt', 'a')
    ...
    create_output_4bytesASN_list = open(
        output_folder + 'LastYear__4bytes_list_visible_ASNs_peering_in_more_than_1_IXP.txt', 'a')

    create_output_4bytesASN_list.write('###Month-Year; Visible 4bytes Peering ASNs \n')

    create_output_4bytesASN_num = open(
        output_folder + 'LastYear__4bytes_number_visible_ASNs_peering_in_more_than_1_IXP.txt', 'a')
