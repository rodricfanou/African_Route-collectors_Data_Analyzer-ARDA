...
## Create a logfile:
name_log_file = 'Log_' + str(now_datetime) + '_' + 'Regional_9_number_IPv6_vs_IPv4_prefixes_lastyear' + '.txt'
...
if os.listdir(IXPView_output_folder) != []:
    ...
    for ixp in list(IXP_collector.keys()):
        ...
        filename_v4 = 'LastYear_' + ixp + '_List_ASNs_announcing_v4.txt'

        print('Treating v4 file ', filename_v4)
        ...
        filename_v6 = 'LastYear_' + ixp + '_List_ASNs_announcing_v6.txt'

        print('Treating v6 file ', filename_v6)
...
with open(output_folder + 'LastYear__list_Origin_ASNs_advertising_v4_prefixes_at_all_IXPs.txt', 'a') as fg:
    fg.write('%s' % ('###Month-Year; Visible ASNs advertising v4 prefixes\n'))
...
with open(output_folder + 'LastYear__list_Origin_ASNs_advertising_v6_prefixes_at_all_IXPs.txt', 'a') as fg:
    fg.write('%s' % ('###Month-Year; Visible ASNs advertising v6 prefixes\n'))
...
with open(output_folder + 'LastYear__number_Origin_ASNs_advertising_v4_v6_prefixes_at_all_IXPs.txt', 'a') as fg:
    fg.write('%s' % ('###Month-Year; Number ASNs advertising v4 prefixes;  Number ASNs advertising v6 prefixes\n'))
