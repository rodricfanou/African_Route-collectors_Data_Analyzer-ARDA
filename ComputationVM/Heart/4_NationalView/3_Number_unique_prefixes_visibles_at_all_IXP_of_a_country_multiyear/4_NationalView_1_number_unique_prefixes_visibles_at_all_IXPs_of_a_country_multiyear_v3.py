...
for CC in month_prefix:
    ...
    with open (output_folder +'MultiYear__list_visible_prefixes_at_IXP_' + CC + '.txt', 'a') as fh21:
        
        fh21.write('%s\n' %("""###Year; Visible prefixes at the IXP"""))
...
for CC in month_prefix:
    ...
    with open (output_folder +'MultiYear__number_visible_prefixes_at_IXP_' + CC + '.txt', 'a') as fh4:
        ...
        fh4.write('%s\n' %("""###Year; Number of Visible prefixes at the IXP"""))
    ...
    for couple_timestamp11 in list(month_prefix[CC].keys()):
        ...
        if couple_timestamp11 in list(month_prefix_bogon[CC].keys()):
            ...
            with open (output_folder + 'MultiYear__number_visible_prefixes_at_IXP_' + CC + '.txt', 'a') as fh4:
                ...
                fh4.write('%s; %s; %s\n' %(couple_timestamp11, str(len(month_prefix[CC][couple_timestamp11])), str(len(month_prefix_bogon[CC][couple_timestamp11])) ))
