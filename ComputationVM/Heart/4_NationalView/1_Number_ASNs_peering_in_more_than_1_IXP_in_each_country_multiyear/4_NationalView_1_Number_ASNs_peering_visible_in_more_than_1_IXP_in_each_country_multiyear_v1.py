...
for ixp in list(IXP_collector.keys()):
    ...
    if os.path.isfile (output_folder + 'MultiYear__2bytes_list_peering_ASNs_in_more_than_1_IXP_in_' + CC_to_consider + '.txt'):
        
        create_output_2bytesASN_list = open(output_folder+'MultiYear__2bytes_list_peering_ASNs_in_more_than_1_IXP_in_' + CC_to_consider + '.txt', 'a')
...
for ixp in list(IXP_collector.keys()):
    ...
    if os.path.isfile (output_folder + 'MultiYear__4bytes_list_peering_ASNs_in_more_than_1_IXP_in_' + CC_to_consider + '.txt'):
        
        create_output_4bytesASN_list = open(output_folder+'MultiYear__4bytes_list_peering_ASNs_in_more_than_1_IXP_in_' + CC_to_consider + '.txt', 'a')
