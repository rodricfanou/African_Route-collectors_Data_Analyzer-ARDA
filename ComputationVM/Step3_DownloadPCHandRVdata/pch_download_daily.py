...
for elem in yearList:
    for month in monthList:
        ...
        os.system(command)
        command = "wget https://www.pch.net/resources/Routing_Data/IPv4_daily_snapshots/" + str(elem) + "/" + str(
            month) + "/"
                ...
                for line2 in index_packets:
                    ...
                    try:
                        ...
                        if (dia_de_descarga in url_to_file):
                            command = " wget https://www.pch.net/resources/Routing_Data/IPv4_daily_snapshots/" + str(
                    ...
                    os.chdir(path + "/" + str(elem) + "/" + str(month))
os.chdir(path)
command = 'python3 ./daily_victor_roderick_parsing_vtest.py'
os.system(command)
outfile = open('Debug_time.txt', 'a')
