...
while 1:
    ...
    os.system("python3 1_clean_RIRs_DBs.py")
    ...
    folder_download = "ftp://ftp.afrinic.net/pub/stats/afrinic/"
    ...
    ## Run next script
    os.system("python3 2_fill_historical_AFRINIC_v3_IPv4prefixesonly.py")

    ## Run next script
    os.system("python3 2_fill_historical_AFRINIC_v3_IPv6prefixesonly.py")

    ## Run next script
    os.system("python3 3_fill_historical_APNIC_v3_ASNsonly.py")

    ## Run next script
    os.system("python3 3_fill_historical_APNIC_v3_IPv4prefixesonly.py")

    ## Run next script
    os.system("python3 3_fill_historical_APNIC_v3_IPv6prefixesonly.py")

    ## Run next script
    os.system("python3 4_fill_historical_ARIN_v3_ASNsonly.py")

    ## Run next script
    os.system("python3 4_fill_historical_ARIN_v3_IPv4prefixesonly.py")

    ## Run next script
    os.system("python3 4_fill_historical_ARIN_v3_IPv6prefixesonly.py")

    ## Run next script
    os.system("python3 5_fill_historical_LACNIC_v3_ASNsonly.py")

    ## Run next script
    os.system("python 5_fill_historical_LACNIC_v3_IPv4prefixesonly.py")

    ## Run next script
    os.system("python3 5_fill_historical_LACNIC_v3_IPv6prefixesonly.py")

    ## Run next script
    os.system("python3 6_fill_historical_RIPE_v3_ASNsonly.py")

    ## Run next script
    os.system("python3 6_fill_historical_RIPE_v3_IPv4prefixesonly.py")

    ## Run next script
    os.system("python3 6_fill_historical_RIPE_v3_IPv6prefixesonly.py")
